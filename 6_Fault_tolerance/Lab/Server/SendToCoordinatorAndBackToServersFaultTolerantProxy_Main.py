...
# Wrap each proxy with a fault tolerant proxy object
serversToInformAboutChanges = [FaultTolerantProxy.storage(serversToInformAboutChanges[id]) for id in range(len(serverPorts))]
